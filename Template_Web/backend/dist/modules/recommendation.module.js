...
const recommendation_profile_schema_1 = require("../schemas/recommendation-profile.schema");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                ...
                { name: 'RecommendationProfile', schema: recommendation_profile_schema_1.RecommendationProfileSchema },
            ]),
        ],
